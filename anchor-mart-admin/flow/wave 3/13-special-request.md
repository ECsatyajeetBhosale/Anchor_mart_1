...
| **Documentation Version** | 1.1 — 2026-07-23 (FP1: transitions routed through the state-machine gate; FP2: `variant` field flagged unused) |
...
CUSTOMER — base /api/catalog/
 ├─ POST add-special-request/                 { product_name, category_id, ship_arrival_date, shipping_address, … }
...
| `category_id` | ✅ | UUID — a **general-scope** catalog category |
| `ship_arrival_date` | ✅ | Datetime (ISO-8601 / `YYYY-MM-DD`) |
| `shipping_address` | ✅ | Object — free-form snapshot, stored as sent |
...
| `port_id` / `anchorage_id` | ✖ | UUID |
| `images` | ✖ | list of paths under `special_request_images/` (Flow 26 upload) |
