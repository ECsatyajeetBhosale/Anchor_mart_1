...
import type { OrderTimelineStep } from "@/features/assignments";
...
export interface IntentLifecycleRailProps {
...
/**
 * Live steps → segments. The first not-done step is the one in progress;
 * everything after it is pending. An all-done ladder has no active segment.
 */
...
/**
 * Compact horizontal progress rail for an intent — where the order currently
 ...
 */
export function IntentLifecycleRail({ status, steps, className }: IntentLifecycleRailProps) {
...
export default IntentLifecycleRail;
